...
1. **Study / quiz me / practice / mock exam / revise topic X** → use the **uni-tutor** skill.
2. **Import / summarize / digest course material** — slides, scripts, notes, past exams, exam info from the professor → **uni-import**.
3. **Plan my revision / "exam is on [date]" / I'm behind** → **uni-plan**.
4. **Rate my confidence / self-assessment / "I don't know where I stand"** → **uni-assess**.
5. **Check my own solution / "where would I lose points" / "I'm stuck on task N"** → **uni-check**.
